     ...
     return (
          <div className = "destination" id="body">
                ...
                <main className="main-container grid-container--destination flow">      
                 ...
                 <img className= "planet-image" src={Array[2]?.img} alt="the moon"/>
                    <div className="tabs-list">
                        <DestinationNav/>
                    </div>      
             <article className="destination-info  flow">
                    <span className="uppercase font-Bellefair leading-mid-tight planet--name">{Array[2]?.name}</span>
             ...
             <div className="destination-meta">
               <div>
                    ...
                    <p className="uppercase font-Bellefair text-2xl">{Array[2]?.AvgDistance}</p>
               </div>
               <div>
                    <h3 className="uppercase text-xs text-white/60">Est. travel time</h3>
                    <p className="uppercase font-Bellefair text-2xl">{Array[2]?.travelTime}</p>
               </div>
           </div>
              </div>
          </article>

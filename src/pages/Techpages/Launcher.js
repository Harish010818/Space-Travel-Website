        ...
        <main className="flex flex-row item-center gap-20 ml-44 mt-44">
                  <div className="flex flex-col gap-10 -mt-36">
                      ...
                      <div className="flex flex-col max-w-lg gap-2 -mt-8">
                           ...
                           <span className="uppercase text-6xl [letter-spacing:2px]">{Array[0]?.name}</span>
                           <p className="mt-5 text-xm max-w-sm">{Array[0]?.description}</p>
                      </div>

                         </div>
                  </div>
                  
                  <img  className = "w-96 h-96 -mt-24" src = {Array[0]?.images} alt="space-technology"/> 
           </main>
    )
}
